      ...
      return {
        data: {
          football_equipments: [
            {
              id: 1,
              image: `${IMAGE_URL}/images/soccer1.jpg`,
              name: 'aadi Trendy Lightweight Sports',
              description:
            ...
            {
              id: 2,
              image: `${IMAGE_URL}/images/ball1.webp`,
              name: 'adidas Fussballliebe',
              description:
            ...
            {
              id: 3,
              image: `${IMAGE_URL}/images/uniform1.avif`,
              name: 'China Manufacture Polyester',
              description:
            ...
            {
              id: 4,
              image: `${IMAGE_URL}/images/soccer2.webp`,
            ...
            {
              id: 5,
              image: `${IMAGE_URL}/images/ball2.jpeg`,
            ...
            {
              id: 6,
              image: `${IMAGE_URL}/images/uniform2.avif`,
              name: 'Nike Academy',
              description:
          ...
          volleyball_equipments: [
            {
              id: 1,
              image: `${IMAGE_URL}/images/shoes1.webp`,
              name: 'Latest Stylish Casual Sneaker',
              description:
            ...
            {
              id: 2,
              image: `${IMAGE_URL}/images/ball3.webp`,
            ...
            {
              id: 3,
              image: `${IMAGE_URL}/images/shoes2.avif`,
              name: 'HACKY SPORTS',
              description:
            ...
            {
              id: 4,
              image: `${IMAGE_URL}/images/uniform9.webp`,
              name: 'Nike P-6000',
              description:
            ...
            {
              id: 5,
              image: `${IMAGE_URL}/images/uniform6.jpg`,
              name: 'Nike Strike',
              description:
            ...
            {
              id: 6,
              image: `${IMAGE_URL}/images/ball4.jpg`,
              name: 'Nike Pitch',
              description:
          ...
          tennis_equipments: [
            {
              id: 1,
              image: `${IMAGE_URL}/images/shoes7.webp`,
            ...
            {
              id: 2,
              image: `${IMAGE_URL}/images/table1.webp`,
              name: 'MAPOL 200 Count Table Tennis',
              description:
            ...
            {
              id: 3,
              image: `${IMAGE_URL}/images/uniform11.webp`,
              name: 'Soccer Uniform',
              description:
            ...
            {
              id: 4,
              image: `${IMAGE_URL}/images/shoes6.webp`,
            ...
            {
              id: 5,
              image: `${IMAGE_URL}/images/uniform10.webp`,
              name: 'Paris Saint-Germain',
              description:
            ...
            {
              id: 6,
              image: `${IMAGE_URL}/images/table2.webp`,
